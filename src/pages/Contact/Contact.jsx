...
export default function Contact() {
  ...
  <div className="row">
    ...
    <div className="col-12 col-md-6">
      ...
      >
        ...
        <div className="row mb-4">
          <div className="col-12">
            ...
            <input
              id="name"
              type="text"
              className={`form-control rounded-pill w-100 p-2 ${
          ...
          <div className="col-12 mt-3">
            ...
            <select
              className={`form-select rounded-pill w-100 ${
                formik.errors.department && formik.touched.department ? "is-invalid" : ""
              }`}
              id="department"
        ...
        <div className="mb-3">
          ...
          <textarea
            className={`form-control rounded w-100 p-2 ${
              formik.errors.question && formik.touched.question ? "is-invalid" : ""
            }`}
            id="question"
            rows="4"
        ...
        <div className="d-grid">
          <button type="submit" className="btn btn-light text-primary rounded-pill py-2 my-5">
            Ask
          </button>
        </div>
      </form>
    ...
    <div className="col-12 col-md-6">
      <div
        className="map-container rounded-3 my-5 shadow overflow-hidden"
        style={{ height: "600px" }}
      >
        <iframe
          title="Google Map"
